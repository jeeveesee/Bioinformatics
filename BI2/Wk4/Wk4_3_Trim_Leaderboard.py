...
# Linear Scoring
def trim(leaderboard: list[str], experimental_spectrum: list[int], N):
    """
    Trims the leaderboard peptides to N-main linear peptides scoring highest to spectrum

    Parameters:
    leaderboard -> list of leaderboard peptides
    ...
    len_leaderboard = len(leaderboard)
    scores = []
