...
def leaderboard_cyclopeptide_sequencing(experimental_spectrum: list[int], N: int, amino_acid_masses):
    """
    ...
    Parameters:
        ...
        amino_acid_masses -> amino acid masses for the spectrum
...
##############################
def expand(peptides: list[int], amino_acid_masses: list[int]) -> list:
    """Expand candidate peptides.

    Parameters:
        peptides: list of tuples of amino acid and mass e.g., [('X', 128), ]
        amino_acid_masses: list of amino acid masses, generally between 57 and 201
...
# Sample test
    ...
    leaders, best_score = leaderboard_cyclopeptide_sequencing(experimental_spectrum, N, AMINO_ACID_MASSES)
