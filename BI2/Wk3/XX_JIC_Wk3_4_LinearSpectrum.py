...
def linear_spectrum(amino_acid_mass_map, peptide_string):
    """
    ...
    for aa in peptide_string:
        prefix_mass.append(prefix_mass[-1] + amino_acid_mass_map.get(aa))
...
# Sample test
    ...
    answer = linear_spectrum(AMINO_ACID_MASS_MAP, peptide_string)
    # print(''.join(answer))
    print(*answer)
